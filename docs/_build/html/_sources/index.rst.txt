...
Automatic signature-based annotation at single cell resolution.
...
.. toctree::
   ...
   Documentation <modules_modified>
   Tutorial: CIA workflow <tutorial/workflow/Cluster_Independent_Annotation>
   Tutorial: CIA benchmarking <tutorial/benchmark/CIA_benchmarking>
   License <license>
   Authors <authors>
   Changelog <changelog>
